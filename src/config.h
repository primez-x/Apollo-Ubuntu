...
namespace config {
  ...
  struct video_t {
    ...
    std::string linux_gamescope_session_command;
    ...
    double minimum_fps_target;  ///< Lowest framerate that will be used when streaming. Range 0-1000, 0 = half the client's requested framerate.
